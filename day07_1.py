...
hose programs are, in turn, holding up other programs; in this example, none of those programs are holding up any
...
# dict with key = name and value = father
names = dict()

for line in input.split("\n"):
    try:
        name, childrens = line.split(" -> ")
        name, _ = name.split(" ")
